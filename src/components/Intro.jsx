  ...
  return (
    <>
      ...
      <div className=" w-5/6 h-3/5  flex flex-col font-inter items-center rounded-xl text-white top-[31.3vh] absolute bg-transparent  backdrop-filter-none  p-8 box-border overflow-hidden">
        <h1 className=" font-semibold text-xl sm:text-5xl flex flex-row justify-center items-center  text-white"> 
          Florify <img className=" size-8 md:size-14 md:ml-2" src="src/assets/icon.png"></img>
        </h1>
